    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userNoDoc', models.IntegerField(db_comment='Numero de documento', max_length=15, unique=True)),
                ('userTelefono', models.IntegerField(db_comment='Telefono del usuario', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('detCantida', models.IntegerField(db_comment='Cantidad del producto', max_length=30)),
                ('detPrecio', models.IntegerField(db_comment='Precio por cada producto', max_length=11)),
            ],
        ),
        migrations.CreateModel(
            name='DetellaEnvio',
            fields=[
                ...
                ('detNitDestinatario', models.IntegerField(db_comment='tipo de documento a quien se envia', max_length=12)),
                ('detDescripcion', models.TextField(db_comment='Descripcion del envio', max_length=200)),
                ('detTelefonoDestinatario', models.IntegerField(db_comment='Telefono del quien recibe', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emTelefono', models.IntegerField(db_comment='Numero telefonico del empleado', max_length=11)),
                ...
                ('emNumeroDoc', models.IntegerField(db_comment='Numero de identificacion', max_length=12, unique=True)),
                ('emCargo', models.CharField(db_comment='Nombre del cargo que ejerce', max_length=30)),
                ('correo', models.CharField(db_comment='Direccion del correo electronico', max_length=30, unique=True)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proTelefono', models.IntegerField(db_comment='Telefono de la empresa', max_length=12)),
                ('proNit', models.IntegerField(db_comment='NIT de la empresa', max_length=12)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('traPrecio', models.IntegerField(db_comment='Precio del Tratamiento', max_length=12)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('traEmpleado', models.ForeignKey(db_comment='El empleado que atiende este servicio', on_delete=django.db.models.deletion.PROTECT, to='appVeterinaria.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Producto',
            fields=[
                ...
                ('proPrecio', models.IntegerField(db_comment='Precio del producto', max_length=14)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peCodigoComprobante', models.IntegerField(db_comment='Codigo del comprobante', max_length=6)),
                ('fechaHoraCreacion', models.DateTimeField(auto_now_add=True, db_comment='Fecha y hora del registro')),
                ('fechaHoraActualizacion', models.DateTimeField(auto_now=True, db_comment='Fecha y hora última actualización')),
                ('peImpuestoPedido', models.IntegerField(db_comment='Impuesto del pedido', max_length=10, null=True)),
                ('peTotalPedido', models.IntegerField(db_comment='Total pedido', max_length=13, null=True)),
